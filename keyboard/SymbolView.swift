  ...
  var body: some View {
    VStack {
      HStack {
        HStack {
          KeyboardButton(
            text: available[page][0], primary: true,
            action: {
          ...
          KeyboardButton(
            text: available[page][1], primary: true,
            action: {
              Feedback.shared.playTypeSound()
              Feedback.shared.playHaptics()
        ...
        HStack {
          KeyboardButton(
            text: available[page][2], primary: true,
            action: {
              Feedback.shared.playTypeSound()
              Feedback.shared.playHaptics()
          ...
          KeyboardButton(
            text: available[page][3], primary: true,
            action: {
              Feedback.shared.playTypeSound()
              Feedback.shared.playHaptics()
        ...
        HStack {
          KeyboardButton(
            text: available[page][4], primary: true,
            action: {
              Feedback.shared.playTypeSound()
              Feedback.shared.playHaptics()
          ...
          KeyboardButton(
            text: available[page][5], primary: true,
            action: {
              Feedback.shared.playTypeSound()
              Feedback.shared.playHaptics()
      ...
      HStack {
        HStack {
          KeyboardButton(
            text: available[page][6], primary: true,
            action: {
              Feedback.shared.playTypeSound()
              Feedback.shared.playHaptics()
          ...
          KeyboardButton(
            text: available[page][7], primary: true,
            action: {
              Feedback.shared.playTypeSound()
              Feedback.shared.playHaptics()
        ...
        HStack {
          KeyboardButton(
            text: available[page][8], primary: true,
            action: {
              Feedback.shared.playTypeSound()
              Feedback.shared.playHaptics()
          ...
          KeyboardButton(
            text: available[page][9], primary: true,
            action: {
              Feedback.shared.playTypeSound()
              Feedback.shared.playHaptics()
        ...
        HStack {
          KeyboardButton(
            text: available[page][10], primary: true,
            action: {
              Feedback.shared.playTypeSound()
              Feedback.shared.playHaptics()
          ...
          KeyboardButton(
            text: available[page][11], primary: true,
            action: {
              Feedback.shared.playTypeSound()
              Feedback.shared.playHaptics()
      ...
      HStack {
        HStack {
          KeyboardButton(
            text: available[page][12], primary: true,
            action: {
              Feedback.shared.playTypeSound()
              Feedback.shared.playHaptics()
          ...
          KeyboardButton(
            text: available[page][13], primary: true,
            action: {
              Feedback.shared.playTypeSound()
              Feedback.shared.playHaptics()
        ...
        HStack {
          KeyboardButton(
            text: available[page][14], primary: true,
            action: {
              Feedback.shared.playTypeSound()
              Feedback.shared.playHaptics()
          ...
          KeyboardButton(
            text: available[page][15], primary: true,
            action: {
              Feedback.shared.playTypeSound()
              Feedback.shared.playHaptics()
        ...
        HStack {
          KeyboardButton(
            text: available[page][16], primary: true,
            action: {
              Feedback.shared.playTypeSound()
              Feedback.shared.playHaptics()
          ...
          KeyboardButton(
            text: available[page][17], primary: true,
            action: {
              Feedback.shared.playTypeSound()
              Feedback.shared.playHaptics()
      ...
      HStack {
        ...
        KeyboardButton(
          text: "\(page + 1)/\(available.count)", primary: true,
          action: {
            Feedback.shared.playModifierSound()
            Feedback.shared.playHaptics()
